...
namespace Savings.API.Migrations
{
    ...
    [Migration("20260323104741_AddFederationApiKeys")]
    partial class AddFederationApiKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Savings.Model.FederationApiKey", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("FederationApiKeys");
                });

            modelBuilder.Entity("Savings.Model.FederationEndpoint", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Savings.Model.MaterializedMoneyItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 0m,
                            Cash = false,
                            Date = new DateTime(2026, 2, 28, 0, 0, 0, 0, DateTimeKind.Local),
                            EndPeriod = true,
